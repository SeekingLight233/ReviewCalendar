<template>
  ...
  >
    ...
    <div class="__result_origin">
      ...
      <audio v-if="!inDict" :id="`x__result-${uuid}`" :src="dict.phonetic" class="__result_audio" />
      ...
      <div class="__result_class" v-for="(wordPos, i) in oxfordTranslations" :key="i">
        ...
        <div class="__result_item-wrap">
          ...
          >
            ...
            >eg. {{translation.example[0].en | removeTag}}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    >
      <div class="__result_more-button" :class="{'__result_more-button--expanded': expanded}"></div>
    </div>
